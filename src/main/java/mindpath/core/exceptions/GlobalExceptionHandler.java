package mindpath.core.exceptions;

import mindpath.core.exceptions.custom.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleInvalidRoleException(@NotNull InvalidRoleException ex) {
        return ex.handle(HttpStatus.BAD_REQUEST, "Invalid Role", ex.getMessage());
    }
