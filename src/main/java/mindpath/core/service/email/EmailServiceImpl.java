package mindpath.core.service.email;

import mindpath.core.exceptions.custom.EmailServiceException;
...
public class EmailServiceImpl implements  EmailService{
    ...
    public void sendMail(String to, String subject, String templateName, Map<String, Object> model) {
        ...
        try {
            ...
            throw new EmailServiceException("Échec de l'envoi de l'email à " + to);
        }
    }
